...
DELETE FROM `creature_loot_template` WHERE `entry` IN (16156,35305,35307,35309);
INSERT INTO `creature_loot_template` (entry, item, ChanceOrQuestChance, lootmode, groupid, mincountOrRef, maxcount) VALUES
(16156, 7910, 1.32, 1, 0, 1, 1),
(16156, 14047, 25.88, 1, 0, 1, 1),
(16156, 19236, 0.56, 1, 0, 1, 1),
(16156, 22708, -1, 1, 0, 1, 1),
(16156, 23055, 1.12, 1, 0, 1, 1),
(16156, 23666, 0.56, 1, 0, 1, 1),
(16156, 24016, 1, 1, 1, -24016, 1),
(16156, 24018, 1, 1, 1, -24018, 1),
(16156, 24020, 1, 1, 1, -24020, 1),
(35305, 45912, 0.1, 1, 0, 1, 1),
(35307, 45912, 0.1, 1, 0, 1, 1),
(35309, 45912, 0.1, 1, 0, 1, 1);

UPDATE `creature_template` SET `lootid`=16156 WHERE `entry` IN (16156, 29833);
UPDATE `creature_template` SET `lootid`=35305 WHERE `entry` IN (35305, 12488);
UPDATE `creature_template` SET `lootid`=35307 WHERE `entry` IN (35307, 12448);
UPDATE `creature_template` SET `lootid`=35309 WHERE `entry` IN (35309, 12439);