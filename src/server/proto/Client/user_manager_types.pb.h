...
void PROTO_API protobuf_AddDesc_user_5fmanager_5ftypes_2eproto();
...
class PROTO_API RecentPlayer : public ::google::protobuf::Message {
 public:
  RecentPlayer();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_user_5fmanager_5ftypes_2eproto();
...
class PROTO_API BlockedPlayer : public ::google::protobuf::Message {
 public:
  BlockedPlayer();
