...
bool AuctionBotSeller::Initialize()
{
    ...
    LOG_DEBUG("ahbot", "Loot filter has %u items", (uint32)lootItems.size());
    ...
    LOG_DEBUG("ahbot", "Items loaded \tGray\tWhite\tGreen\tBlue\tPurple\tOrange\tYellow");
    for (uint32 i = 0; i < MAX_ITEM_CLASS; ++i)
        LOG_DEBUG("ahbot", "\t\t%u\t%u\t%u\t%u\t%u\t%u\t%u",
