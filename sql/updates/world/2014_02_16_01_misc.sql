...
-- double spawns
DELETE FROM creature WHERE guid IN (74352,105610,105440,105770,74354,105657,105638,74346,113954,105792,74363);
DELETE FROM creature_addon WHERE guid IN (74352,105610,105440,105770,74354,105657,105638,74346,113954,105792,74363);
DELETE FROM creature WHERE guid IN (105866,113617,74391,113777,113768,105761,105736,105497,74390);
DELETE FROM creature_addon WHERE guid IN (105866,113617,74391,113777,113768,105761,105736,105497,74390);
DELETE FROM creature WHERE guid IN (105360,74085,105496,113624,113637,74074,105412,113910,105932);
DELETE FROM creature WHERE guid IN (105894,105431,113758,105655,74063,74065,74075,74068,113819,113880);
DELETE FROM creature_addon WHERE guid IN (105360,74085,105496,113624,113637,74074,105412,113910,105932);
DELETE FROM creature_addon WHERE guid IN (105894,105431,113758,105655,74063,74065,74075,74068,113819,113880);
