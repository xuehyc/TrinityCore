...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_NULLSEC_VITAL_AREA_TAKEN = 12014,
    LANG_NULLSEC_VITAL_AREA_LOST  = 12015,
    // .claim command
    LANG_CLAIM_MISSED_ITEM      = 12030,
    LANG_CLAIM_MISSED_GUILD     = 12031,
    LANG_CLAIM_NO_NULLSEC       = 12032,
    LANG_CLAIM_WRONG_AREA       = 12033,
    LANG_CLAIM_HAS_OWNER        = 12034,
    LANG_CLAIM_UNDER_ATTACK     = 12035,
    LANG_CLAIM_ATTACK_STARTED   = 12036,
    // PvP player loot system
    LANG_PVP_MONEY_LOST = 12040,
    LANG_PVP_MONEY_WON  = 12041
};
#endif
