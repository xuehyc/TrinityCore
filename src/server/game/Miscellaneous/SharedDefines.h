...
{
    GUILD_ZONE_NONE                = 0,
    GUILD_ZONE_FELWOOD             = 1,
    GUILD_ZONE_DESOLACE            = 2,
    GUILD_ZONE_DUSTWALLOW_MARSH    = 3,
	GUILD_ZONE_FERALAS             = 4,
	GUILD_ZONE_AZSHARA             = 5,
    TOTAL_GUILD_ZONES              = 5
};
...
enum HighSecZones
{
    ...
    HIGHSEC_ZONE_UNDERCITY       = 1497,
    HIGHSEC_ZONE_IRONFORGE       = 1537,
    HIGHSEC_ZONE_ELWYNN_FOREST   = 12,
    HIGHSEC_ZONE_DUROTAR         = 14,
    HIGHSEC_ZONE_TELDRASSIL      = 141,
    HIGHSEC_ZONE_MULGORE         = 215,
    HIGHSEC_ZONE_TIRISFAL_GLADES = 85,
    HIGHSEC_ZONE_DUN_MOROGH      = 1,
    HIGHSEC_ZONE_DEEPRUN_TRAM    = 2257
...
enum LowSecZones
{
	...
	LOWSEC_ZONE_THOUSAND_NEEDLES     = 400,
	LOWSEC_ZONE_TANARIS              = 440,
	LOWSEC_ZONE_STONETALON_MOUNTAINS = 406,
};
...
enum NullSecZones
{
	...
	NULLSEC_ZONE_AZSHARA          = 16,
    NULLSEC_ZONE_FELWOOD          = 361,
	NULLSEC_ZONE_FERALAS          = 357,
	NULLSEC_ZONE_UNGORO           = 490
};
