...
void PROTO_API protobuf_AddDesc_Login_2eproto();
...
PROTO_API bool AuthenticationState_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* AuthenticationState_descriptor();
...
class PROTO_API ErrorResponse : public ::google::protobuf::Message {
 public:
  ErrorResponse();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_Login_2eproto();
...
class PROTO_API FormInput : public ::google::protobuf::Message {
 public:
  FormInput();
  virtual ~FormInput();
...
class PROTO_API FormInputs : public ::google::protobuf::Message {
 public:
  FormInputs();
  virtual ~FormInputs();
...
class PROTO_API FormInputValue : public ::google::protobuf::Message {
 public:
  FormInputValue();
...
class PROTO_API LoginForm : public ::google::protobuf::Message {
 public:
  LoginForm();
  virtual ~LoginForm();
...
class PROTO_API LoginResult : public ::google::protobuf::Message {
 public:
  LoginResult();
  virtual ~LoginResult();
...
class PROTO_API LoginRefreshResult : public ::google::protobuf::Message {
 public:
  LoginRefreshResult();
...
class PROTO_API GameAccountInfo : public ::google::protobuf::Message {
 public:
  GameAccountInfo();
