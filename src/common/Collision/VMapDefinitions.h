...
#define VMAP_ERROR_LOG(FILTER, ...) LOG_ERROR(FILTER, __VA_ARGS__)
#define VMAP_DEBUG_LOG(FILTER, ...) LOG_DEBUG(FILTER, __VA_ARGS__)
#define VMAP_INFO_LOG(FILTER, ...) LOG_INFO(FILTER, __VA_ARGS__)
#else
