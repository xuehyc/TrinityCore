...
void PROTO_API protobuf_AddDesc_rpc_5fconfig_2eproto();
...
class PROTO_API RPCMethodConfig : public ::google::protobuf::Message {
 public:
  RPCMethodConfig();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_rpc_5fconfig_2eproto();
...
class PROTO_API RPCMeterConfig : public ::google::protobuf::Message {
 public:
  RPCMeterConfig();
...
class PROTO_API ProtocolAlias : public ::google::protobuf::Message {
 public:
  ProtocolAlias();
...
class PROTO_API ServiceAliases : public ::google::protobuf::Message {
 public:
  ServiceAliases();
