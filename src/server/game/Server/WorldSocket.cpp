...
uint8 const ClientTypeSeed_Win[16] = { 0xFA, 0xC2, 0xD6, 0x93, 0xE7, 0x02, 0xB9, 0xEC, 0x9F, 0x75, 0x0F, 0x17, 0x24, 0x56, 0x96, 0xD8 };
uint8 const ClientTypeSeed_Wn64[16] = { 0xA7, 0x52, 0x64, 0x0E, 0x8B, 0x99, 0xFE, 0x5B, 0x57, 0xC1, 0x32, 0x0B, 0xC4, 0x92, 0x89, 0x5A };
uint8 const ClientTypeSeed_Mc64[16] = { 0x92, 0x34, 0xC1, 0xBD, 0x5E, 0x96, 0x87, 0xAD, 0xBD, 0x19, 0xF7, 0x64, 0xF2, 0xE0, 0xE8, 0x11 };
