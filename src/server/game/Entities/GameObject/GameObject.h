...
#ifndef SERVERCORE_GAMEOBJECT_H
#define SERVERCORE_GAMEOBJECT_H
...
class GAME_API GameObject : public WorldObject, public GridObject<GameObject>, public MapObject
{
    public:
        explicit GameObject();
        ~GameObject();
