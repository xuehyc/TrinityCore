...
#ifndef SERVERCORE_COMMON_H
#define SERVERCORE_COMMON_H
...
#  if SERVER_COMPILER == SERVER_COMPILER_INTEL
#    if !defined(BOOST_ASIO_HAS_MOVE)
#      define BOOST_ASIO_HAS_MOVE
#    endif // !defined(BOOST_ASIO_HAS_MOVE)
#  endif // if SERVER_COMPILER == SERVER_COMPILER_INTEL
#else
#  include <sys/types.h>
#  include <sys/ioctl.h>
...
COMMON_API LocaleConstant GetLocaleByName(std::string const& name);

#pragma pack(push, 1)

struct COMMON_API LocalizedString
{
