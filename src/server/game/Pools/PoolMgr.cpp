...
template<>
WH_GAME_API bool ActivePoolData::IsActiveObject<Creature>(uint32 db_guid) const
{
...
template<>
WH_GAME_API bool ActivePoolData::IsActiveObject<GameObject>(uint32 db_guid) const
{
...
template<>
WH_GAME_API bool ActivePoolData::IsActiveObject<Pool>(uint32 sub_pool_id) const
{
