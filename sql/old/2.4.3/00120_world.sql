...
DELETE FROM `server_string` WHERE `entry` IN (25,52,54,55,56,171,401,413,438,593,594,595,596,597,598,599,614,615,636,637,638,809,1000,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1100,1101,1102,1103,1104,1105,1106,1107,1108,1109,1110,1111,1112,1113,1114,1115,1116,1117,1118);
DELETE FROM `server_string` WHERE `entry` BETWEEN '667' AND '687';
DELETE FROM `server_string` WHERE `entry` BETWEEN '711' AND '716';
DELETE FROM `server_string` WHERE `entry` BETWEEN '730' AND '747';
DELETE FROM `server_string` WHERE `entry` BETWEEN '5000' AND '5006';
