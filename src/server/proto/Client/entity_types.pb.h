...
void PROTO_API protobuf_AddDesc_entity_5ftypes_2eproto();
...
class PROTO_API EntityId : public ::google::protobuf::Message {
 public:
  EntityId();
  virtual ~EntityId();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_entity_5ftypes_2eproto();
