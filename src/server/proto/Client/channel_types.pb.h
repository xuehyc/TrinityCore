...
void PROTO_API protobuf_AddDesc_channel_5ftypes_2eproto();
...
PROTO_API bool ChannelState_PrivacyLevel_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* ChannelState_PrivacyLevel_descriptor();
...
class PROTO_API Message : public ::google::protobuf::Message {
 public:
  Message();
  virtual ~Message();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_channel_5ftypes_2eproto();
...
class PROTO_API ListChannelsOptions : public ::google::protobuf::Message {
 public:
  ListChannelsOptions();
...
class PROTO_API ChannelDescription : public ::google::protobuf::Message {
 public:
  ChannelDescription();
...
class PROTO_API ChannelInfo : public ::google::protobuf::Message {
 public:
  ChannelInfo();
  virtual ~ChannelInfo();
...
class PROTO_API ChannelState : public ::google::protobuf::Message {
 public:
  ChannelState();
...
class PROTO_API MemberAccountInfo : public ::google::protobuf::Message {
 public:
  MemberAccountInfo();
...
class PROTO_API MemberState : public ::google::protobuf::Message {
 public:
  MemberState();
  virtual ~MemberState();
...
class PROTO_API Member : public ::google::protobuf::Message {
 public:
  Member();
  virtual ~Member();
