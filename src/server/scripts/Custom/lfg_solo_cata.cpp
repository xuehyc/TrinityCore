...
** Modified and Updated for Gwenpool's 434 branch by SPP DEV MDic https://www.mdicsdildoemporium.com
*/
...
public:
    ...
    void OnLogin(Player* player, bool /*firstLogin*/) override
    {
        ...
        {
            ChatHandler(player->GetSession()).SendSysMessage("This server is running the |cff4CFF00SPP CATA Solo Dungeon Finder|r.");
        }
    }
};
