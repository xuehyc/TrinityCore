...
void PROTO_API protobuf_AddDesc_report_5ftypes_2eproto();
...
PROTO_API bool SpamReport_SpamSource_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* SpamReport_SpamSource_descriptor();
...
class PROTO_API ReportType : public ::google::protobuf::Message {
 public:
  ReportType();
  virtual ~ReportType();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_report_5ftypes_2eproto();
...
class PROTO_API CustomReport : public ::google::protobuf::Message {
 public:
  CustomReport();
...
class PROTO_API SpamReport : public ::google::protobuf::Message {
 public:
  SpamReport();
  virtual ~SpamReport();
...
class PROTO_API HarassmentReport : public ::google::protobuf::Message {
 public:
  HarassmentReport();
...
class PROTO_API RealLifeThreatReport : public ::google::protobuf::Message {
 public:
...
class PROTO_API InappropriateBattleTagReport : public ::google::protobuf::Message {
 public:
...
class PROTO_API HackingReport : public ::google::protobuf::Message {
 public:
  HackingReport();
...
class PROTO_API BottingReport : public ::google::protobuf::Message {
 public:
  BottingReport();
...
class PROTO_API Report : public ::google::protobuf::Message {
 public:
  Report();
  virtual ~Report();
