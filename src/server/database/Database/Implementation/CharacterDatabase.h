...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_INS_MAIL,
    CHAR_DEL_MAIL_BY_ID,
    CHAR_SEL_MAILITEMS_FOR_DELETE,
    CHAR_SEL_MAILITEM,
    CHAR_SEL_MAILITEMS,
    CHAR_INS_MAIL_ITEM,
    CHAR_DEL_MAIL_ITEM,
    CHAR_DEL_MAIL_ITEMS_BY_MAILID,
    CHAR_DEL_MAIL_ITEMS_BY_CHAR,
    CHAR_UPD_MAIL_MONEY_RECEIVED,
    CHAR_UPD_MAIL_MARK_AS_READ,
    CHAR_UPD_MAIL_ITEM_OLDMAILID_BY_MAILID,
    CHAR_UPD_ITEM_OWNER,
    CHAR_UPD_MAIL_ITEM_HAS_ITEM,
    CHAR_UPD_MAIL_STATE,
