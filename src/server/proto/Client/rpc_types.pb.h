...
void PROTO_API protobuf_AddDesc_rpc_5ftypes_2eproto();
...
PROTO_API bool TraceInfo_Sampling_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* TraceInfo_Sampling_descriptor();
...
class PROTO_API NO_RESPONSE : public ::google::protobuf::Message {
 public:
  NO_RESPONSE();
  virtual ~NO_RESPONSE();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_rpc_5ftypes_2eproto();
...
class PROTO_API Address : public ::google::protobuf::Message {
 public:
  Address();
  virtual ~Address();
...
class PROTO_API ProcessId : public ::google::protobuf::Message {
 public:
  ProcessId();
  virtual ~ProcessId();
...
class PROTO_API ObjectAddress : public ::google::protobuf::Message {
 public:
  ObjectAddress();
...
class PROTO_API NoData : public ::google::protobuf::Message {
 public:
  NoData();
  virtual ~NoData();
...
class PROTO_API ErrorInfo : public ::google::protobuf::Message {
 public:
  ErrorInfo();
  virtual ~ErrorInfo();
...
class PROTO_API TraceInfo : public ::google::protobuf::Message {
 public:
  TraceInfo();
  virtual ~TraceInfo();
...
class PROTO_API Header : public ::google::protobuf::Message {
 public:
  Header();
  virtual ~Header();
