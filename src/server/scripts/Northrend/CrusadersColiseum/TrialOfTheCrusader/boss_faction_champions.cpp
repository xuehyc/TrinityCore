        ...
        for (std::list<HostileReference*>::const_iterator itr = tList.begin(); itr != tList.end(); ++itr)
        {
            ...
            if (pUnit && me->getThreatManager().getThreat(pUnit))
            {
                if (pUnit->GetTypeId()==TYPEID_PLAYER)
                {
                    ...
                    me->AddThreat(pUnit, 100000000.0f * threat); // changed from 1000000.0f
                }
            }
        }
    }
...
public:
    ...
    struct mob_toc_druidAI : public boss_faction_championsAI
    {
        ...
        void Reset()
        {
            ...
            m_uiCommonTimer = 1*IN_MILLISECONDS;
...
public:
    ...
    struct mob_toc_paladinAI : public boss_faction_championsAI
    {
        ...
        void Reset()
        {
            ...
            m_uiCommonTimer = urand(1*IN_MILLISECONDS, 2*IN_MILLISECONDS);
