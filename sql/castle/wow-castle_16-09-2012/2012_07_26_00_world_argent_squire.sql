-- set gossip and vendor flags
UPDATE creature_template SET npcflag = npcflag | 0x81, gossip_menu_id = 50000, `ScriptName` = 'npc_pet_argent_squire' WHERE `entry` = 33238;
UPDATE creature_template SET npcflag = npcflag | 0x81, gossip_menu_id = 50001, `ScriptName` = 'npc_pet_argent_squire' WHERE `entry` = 33239;
...
-- when the errand buff times out the squire gets tired
