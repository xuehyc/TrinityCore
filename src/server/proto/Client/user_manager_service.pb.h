...
void PROTO_API protobuf_AddDesc_user_5fmanager_5fservice_2eproto();
...
class PROTO_API SubscribeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_user_5fmanager_5fservice_2eproto();
...
class PROTO_API SubscribeResponse : public ::google::protobuf::Message {
 public:
  SubscribeResponse();
...
class PROTO_API AddRecentPlayersRequest : public ::google::protobuf::Message {
 public:
...
class PROTO_API AddRecentPlayersResponse : public ::google::protobuf::Message {
 public:
...
class PROTO_API ClearRecentPlayersRequest : public ::google::protobuf::Message {
 public:
...
class PROTO_API ClearRecentPlayersResponse : public ::google::protobuf::Message {
 public:
...
class PROTO_API BlockPlayerRequest : public ::google::protobuf::Message {
 public:
  BlockPlayerRequest();
...
class PROTO_API UnblockPlayerRequest : public ::google::protobuf::Message {
 public:
...
class PROTO_API BlockedPlayerAddedNotification : public ::google::protobuf::Message {
 public:
...
class PROTO_API BlockedPlayerRemovedNotification : public ::google::protobuf::Message {
 public:
...
class PROTO_API RecentPlayersAddedNotification : public ::google::protobuf::Message {
 public:
...
class PROTO_API RecentPlayersRemovedNotification : public ::google::protobuf::Message {
 public:
...
class PROTO_API UserManagerService : public ServiceBase
{
 public:
...
class PROTO_API UserManagerListener : public ServiceBase
{
 public:
