...
struct GAME_API ThreatCalcHelper
{
...
//==============================================================
class GAME_API HostileReference : public Reference<Unit, ThreatManager>
{
    public:
...
class GAME_API ThreatContainer
{
