...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        Server::AnyUnitInObjectRangeCheck go_check(object, radius);
        Server::CreatureListSearcher<Server::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
