-- Add Server String for Spirit Guide and wintergrasp battle mage
DELETE FROM `server_string` WHERE `entry` IN (20071,20072,20074,20073,20070,20075,20076,20077);
