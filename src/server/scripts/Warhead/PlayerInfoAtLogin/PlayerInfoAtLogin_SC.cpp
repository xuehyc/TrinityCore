...
public:
    ...
    void OnLogin(Player* player, bool /*firstLogin*/) override
    {
        ...
        // #6. World uptime
        sModuleLocale->SendPlayerMessage(player, MODULE_NAME, PIAL_LOCALE_MSG_UPTIME, Warhead::Time::ToTimeString<Seconds>(GameTime::GetUptime(), TimeOutput::Seconds, TimeFormat::FullText).c_str());
