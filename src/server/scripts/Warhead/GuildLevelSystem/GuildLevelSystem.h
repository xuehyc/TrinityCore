...
public:
    ...
    void UnLearnSpells(ObjectGuid guid);
...
public:
    ...
    void GetRewardsCriteria(Player* player, uint32 sender, uint32 action);
    void GetAllLink(Player* player, Creature* creature, uint32 action);
    void SetNextStage(Player* player);

    // Spells
    void UnLearnSpellsForPlayer(ObjectGuid guid, uint32 guildID);
