...
UPDATE creature_template SET ScriptName = 'npc_ahunite_hailstone' WHERE entry IN (25755);
UPDATE creature_template SET ScriptName = 'npc_ahunite_coldweave' WHERE entry IN (25756);
UPDATE creature_template SET ScriptName = 'npc_ahunite_frostwind' WHERE entry IN (25757);

-- update npc levels to wotlk, set factions to monster
UPDATE creature_template SET minLevel = 82, maxLevel = 82, faction_A = 14, faction_H = 14, dmgMultiplier = 2 WHERE entry = 26338;
UPDATE creature_template SET minLevel = 73, maxLevel = 73, faction_A = 14, faction_H = 14 WHERE entry = 25740;
UPDATE creature_template SET minLevel = 80, maxLevel = 80, faction_A = 14, faction_H = 14, dmgMultiplier = 2 WHERE entry IN (26339, 26342, 26340, 26341);
...
-- spawn ice stone
DELETE FROM `gameobject` WHERE entry IN (187882) AND map = 547;
