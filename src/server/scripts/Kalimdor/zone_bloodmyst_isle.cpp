        ...
        void WaypointReached(uint32 waypointId, uint32 /*pathId*/) override
        {
            ...
            switch (waypointId)
            {
                ...
                case WP_SIRONAS_HILL:
                {
                    ...
                    Warhead::AllCreaturesOfEntryInRange check(me, NPC_SIRONAS, SIZE_OF_GRIDS);
                    Warhead::CreatureSearcher<Warhead::AllCreaturesOfEntryInRange> searcher(me, sironas, check);
