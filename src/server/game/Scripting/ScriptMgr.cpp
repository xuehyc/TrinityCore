        ...
        if (uint32 const id = sObjectMgr->GetScriptId(script->GetName()))
        {
            ...
            for (auto const& stored_script : _scripts)
            {
                ...
                if (stored_script.second->GetName() == script->GetName())
                {
                    ...
                    LOG_ERROR("scripts", "Script '%s' already assigned with the same script name, "
...
template class GAME_API ScriptRegistry<SpellScriptLoader>;
template class GAME_API ScriptRegistry<ServerScript>;
template class GAME_API ScriptRegistry<WorldScript>;
template class GAME_API ScriptRegistry<FormulaScript>;
template class GAME_API ScriptRegistry<WorldMapScript>;
template class GAME_API ScriptRegistry<InstanceMapScript>;
template class GAME_API ScriptRegistry<BattlegroundMapScript>;
template class GAME_API ScriptRegistry<ItemScript>;
template class GAME_API ScriptRegistry<CreatureScript>;
template class GAME_API ScriptRegistry<GameObjectScript>;
template class GAME_API ScriptRegistry<AreaTriggerScript>;
template class GAME_API ScriptRegistry<BattlegroundScript>;
template class GAME_API ScriptRegistry<OutdoorPvPScript>;
template class GAME_API ScriptRegistry<CommandScript>;
template class GAME_API ScriptRegistry<WeatherScript>;
template class GAME_API ScriptRegistry<AuctionHouseScript>;
template class GAME_API ScriptRegistry<ConditionScript>;
template class GAME_API ScriptRegistry<VehicleScript>;
template class GAME_API ScriptRegistry<DynamicObjectScript>;
template class GAME_API ScriptRegistry<TransportScript>;
template class GAME_API ScriptRegistry<AchievementCriteriaScript>;
template class GAME_API ScriptRegistry<PlayerScript>;
template class GAME_API ScriptRegistry<GuildScript>;
template class GAME_API ScriptRegistry<GroupScript>;
template class GAME_API ScriptRegistry<UnitScript>;
template class GAME_API ScriptRegistry<AccountScript>;
template class GAME_API ScriptRegistry<AreaTriggerEntityScript>;
template class GAME_API ScriptRegistry<ConversationScript>;
template class GAME_API ScriptRegistry<SceneScript>;
template class GAME_API ScriptRegistry<QuestScript>;
