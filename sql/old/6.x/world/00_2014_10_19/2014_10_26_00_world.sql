UPDATE `server_string` SET `content_default`='Sender: %s(%llu), Receiver: %s(%llu)' WHERE `entry`=1153;
UPDATE `server_string` SET `content_default`='%llu - sender: %s (guid: %llu account: %u) receiver: %s (guid: %llu account: %u) %s' WHERE `entry`=509;
UPDATE `server_string` SET `content_default`='Game Object |cffffffff|Hgameobject:%llu|h[%s]|h|r (%s) turned' WHERE `entry`=276;
UPDATE `server_string` SET `content_default`='Game Object |cffffffff|Hgameobject:%llu|h[%s]|h|r (%s) moved' WHERE `entry`=277;
UPDATE `server_string` SET `content_default`='%d (Entry: %d) - |cffffffff|Hgameobject:%llu|h[%s X:%f Y:%f Z:%f MapId:%d]|h|r ' WHERE `entry`=517;
...
UPDATE `server_string` SET `content_default`='%llu - |cffffffff|Hcreature:%llu|h[%s X:%f Y:%f Z:%f MapId:%d]|h|r' WHERE `entry`=515;
UPDATE `server_string` SET `content_default`='%llu - %s X:%f Y:%f Z:%f MapId:%d' WHERE `entry`=1110;
UPDATE `server_string` SET `content_default`='%llu - %s X:%f Y:%f Z:%f MapId:%d' WHERE `entry`=1111;
UPDATE `server_string` SET `content_default`='Character guid %llu in use!' WHERE `entry`=1117;
UPDATE `server_string` SET `content_default`='Game Object (GUID: %llu) not found' WHERE `entry`=273;
UPDATE `server_string` SET `content_default`='>> Add Game Object ''%i'' (%s) (GUID: %llu) added at ''%f %f %f''.' WHERE `entry`=525;
UPDATE `server_string` SET `content_default`='Creature (GUID: %llu) not found' WHERE `entry`=287;
