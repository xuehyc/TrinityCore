...
-- has active creature_questender 
...
-- all are obsolete since 3.0.8, so i remove the active creature_questender entry's

delete from creature_questender where id=15701 and quest in (8795,8796,8797,8846,10501);
