...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "server_string",                rbac::RBAC_PERM_COMMAND_RELOAD_SERVER_STRING,                   true,  &HandleReloadServerStringCommand,              "" },
    ...
    {
        LOG_INFO("misc", "Re-Loading Support System Tables...");
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadServerStringCommand(handler, "");
    ...
    {
        LOG_INFO("misc", "Re-Loading Additional Criteria Data...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Character Templates...");
    ...
    {
        LOG_INFO("misc", "Re-Loading creature award reputation definitions...");
    ...
    static bool HandleReloadServerStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        LOG_INFO("misc", "Re-Loading server_string Table!");
        sObjectMgr->LoadServerStrings();
        handler->SendGlobalGMSysMessage("DB table `server_string` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Achievement Reward Data...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Creature ...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Creature Texts...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Gameobject ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Gossip Menu Option ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Page Text ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Points Of Interest ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Quest Locale ... ");
    ...
    {
        LOG_INFO("misc", "Reloading areatrigger_template table...");
    ...
    {
        LOG_INFO("misc", "Reloading scene_template table...");
    ...
    {
        LOG_INFO("misc", "Reloading conversation_* tables...");
