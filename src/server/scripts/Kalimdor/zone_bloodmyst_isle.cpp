        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            switch (waypointId)
            {
                ...
                case WP_SIRONAS_HILL:
                {
                    ...
                    Server::AllCreaturesOfEntryInRange check(me, NPC_SIRONAS, SIZE_OF_GRIDS);
                    Server::CreatureSearcher<Server::AllCreaturesOfEntryInRange> searcher(me, sironas, check);
