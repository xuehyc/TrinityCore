...
void PROTO_API protobuf_AddDesc_resource_5fservice_2eproto();
...
class PROTO_API ContentHandleRequest : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_resource_5fservice_2eproto();
...
class PROTO_API ResourcesService : public ServiceBase
{
 public:
