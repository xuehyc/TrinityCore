DELETE FROM server_string WHERE entry IN (1119,1120,1121);
...
DELETE FROM server_string WHERE entry IN (453);
...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
('server exit',4,'Syntax: .server exit\r\n\r\nTerminate mobius-core NOW. Exit code 0.'),
...
DELETE FROM server_string WHERE entry IN (251);
INSERT INTO server_string VALUES
