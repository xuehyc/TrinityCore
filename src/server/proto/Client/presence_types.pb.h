...
void PROTO_API protobuf_AddDesc_presence_5ftypes_2eproto();
...
PROTO_API bool FieldOperation_OperationType_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* FieldOperation_OperationType_descriptor();
...
class PROTO_API RichPresenceLocalizationKey : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_presence_5ftypes_2eproto();
...
class PROTO_API FieldKey : public ::google::protobuf::Message {
 public:
  FieldKey();
  virtual ~FieldKey();
...
class PROTO_API Field : public ::google::protobuf::Message {
 public:
  Field();
  virtual ~Field();
...
class PROTO_API FieldOperation : public ::google::protobuf::Message {
 public:
  FieldOperation();
