...
void PROTO_API protobuf_AddDesc_friends_5ftypes_2eproto();
...
class PROTO_API Friend : public ::google::protobuf::Message {
 public:
  Friend();
  virtual ~Friend();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_friends_5ftypes_2eproto();
...
class PROTO_API FriendOfFriend : public ::google::protobuf::Message {
 public:
  FriendOfFriend();
...
class PROTO_API FriendInvitation : public ::google::protobuf::Message {
 public:
  FriendInvitation();
...
class PROTO_API FriendInvitationParams : public ::google::protobuf::Message {
 public:
