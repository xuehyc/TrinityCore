...
void PROTO_API protobuf_AddDesc_notification_5ftypes_2eproto();
...
class PROTO_API Target : public ::google::protobuf::Message {
 public:
  Target();
  virtual ~Target();
 ...
 private:
  ...
  ::std::string* type_;
  friend void PROTO_API protobuf_AddDesc_notification_5ftypes_2eproto();
...
class PROTO_API Subscription : public ::google::protobuf::Message {
 public:
  Subscription();
...
class PROTO_API Notification : public ::google::protobuf::Message {
 public:
  Notification();
