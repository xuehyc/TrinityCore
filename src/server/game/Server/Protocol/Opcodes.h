...
enum Opcodes
{
    ...
    MSG_LIST_STABLED_PETS                             = 0x0834, // hope this works (4.3.4) --- found in the mangosthree source
    CMSG_STABLE_PET                                   = 0x1271, // hope this works (4.3.4) --- found in the mangosthree source
    CMSG_UNSTABLE_PET                                 = 0x1272, // hope this works (4.3.4) --- found in the mangosthree source
    CMSG_BUY_STABLE_SLOT                              = 0x1273, // hope this works (4.3.4) --- found in the mangosthree source
    SMSG_STABLE_RESULT                                = 0x2204, // hope this works (4.3.4) --- found in the mangosthree source
    CMSG_STABLE_REVIVE_PET                            = 0x1275, // hope this works (4.3.4) --- found in the mangosthree source
    CMSG_STABLE_SWAP_PET                              = 0x1276, // hope this works (4.3.4) --- found in the mangosthree source
