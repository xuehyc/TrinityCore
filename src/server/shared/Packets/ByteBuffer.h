...
class SHARED_API ByteBufferException : public std::exception
{
public:
...
class SHARED_API ByteBufferPositionException : public ByteBufferException
{
public:
