...
public:
    ...
    void OnChat(Player* player, uint32 /*type*/, uint32 /*lang*/, std::string& /*msg*/, Player* receiver) override
    {
        ...
        if (sMute->CanSpeak(player->GetSession()->GetAccountId()))
            return;
        ...
        std::string muteTimeStr = Warhead::Time::ToTimeString<Seconds>(MuteTime - GameTime::GetGameTime(), TimeOutput::Seconds, TimeFormat::FullText);
