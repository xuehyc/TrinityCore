...
void PROTO_API protobuf_AddDesc_profanity_5ffilter_5fconfig_2eproto();
...
class PROTO_API WordFilter : public ::google::protobuf::Message {
 public:
  WordFilter();
  virtual ~WordFilter();
 ...
 private:
  ...
  ::std::string* type_;
  ::std::string* regex_;
  friend void PROTO_API protobuf_AddDesc_profanity_5ffilter_5fconfig_2eproto();
...
class PROTO_API WordFilters : public ::google::protobuf::Message {
 public:
  WordFilters();
  virtual ~WordFilters();
