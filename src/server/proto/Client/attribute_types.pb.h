...
void PROTO_API protobuf_AddDesc_attribute_5ftypes_2eproto();
...
PROTO_API bool AttributeFilter_Operation_IsValid(int value);
...
PROTO_API const ::google::protobuf::EnumDescriptor* AttributeFilter_Operation_descriptor();
...
class PROTO_API Variant : public ::google::protobuf::Message {
 public:
  Variant();
  virtual ~Variant();
 ...
 private:
  ...
  bool bool_value_;
  friend void PROTO_API protobuf_AddDesc_attribute_5ftypes_2eproto();
...
class PROTO_API Attribute : public ::google::protobuf::Message {
 public:
  Attribute();
  virtual ~Attribute();
...
class PROTO_API AttributeFilter : public ::google::protobuf::Message {
 public:
  AttributeFilter();
