...
void PROTO_API protobuf_AddDesc_game_5futilities_5ftypes_2eproto();
...
class PROTO_API PlayerVariables : public ::google::protobuf::Message {
 public:
  PlayerVariables();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_game_5futilities_5ftypes_2eproto();
...
class PROTO_API ClientInfo : public ::google::protobuf::Message {
 public:
  ClientInfo();
  virtual ~ClientInfo();
