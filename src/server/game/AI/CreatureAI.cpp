...
void CreatureAI::DoZoneInCombat(Creature* creature /*= nullptr*/)
{
    ...
    {
        LOG_ERROR("scripts.ai", "CreatureAI::DoZoneInCombat: call for map that isn't an instance (%s)", creature->GetGUID().ToString().c_str());
        return;
    }
...
void CreatureAI::EnterEvadeMode(EvadeReason why)
{
    ...
    LOG_DEBUG("scripts.ai", "CreatureAI::EnterEvadeMode: entering evade mode (why: %u) (%s)", why, me->GetGUID().ToString().c_str());
