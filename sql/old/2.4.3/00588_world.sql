DELETE FROM `server_string`WHERE `entry` in ('6613', '6614', '6615');
INSERT INTO `server_string` (`entry`,`content_default`) VALUES ('6613','|cfff00000[GM Announcement]: %s|r');
INSERT INTO `server_string` (`entry`,`content_default`) VALUES ('6614','Notification to GM\'s - ');
INSERT INTO `server_string` (`entry`,`content_default`) VALUES ('6615','|cffffff00[|c1f40af20GM Announce by|r |cffff0000%s|cffffff00]:|r %s|r');
