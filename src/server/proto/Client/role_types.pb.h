...
void PROTO_API protobuf_AddDesc_role_5ftypes_2eproto();
...
class PROTO_API Role : public ::google::protobuf::Message {
 public:
  Role();
  virtual ~Role();
 ...
 private:
  ...
  friend void PROTO_API protobuf_AddDesc_role_5ftypes_2eproto();
