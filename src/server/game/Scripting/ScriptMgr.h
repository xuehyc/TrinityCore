...
class PlayerScript : public UnitScript
{
    ...
    public:
        ...
        virtual void OnUpdateZone(Player* /*player*/, uint32 /*newZone*/, uint32 /*newArea*/, bool /*areaOnly*/) { }
...
class ScriptMgr
{
    ...
    public: /* PlayerScript */
        ...
        void OnPlayerUpdateZone(Player* player, uint32 newZone, uint32 newArea, bool areaOnly = false);
