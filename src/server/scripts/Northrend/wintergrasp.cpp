...
#define GOSSIP_HELLO_DEMO1 "Construct catapult."
#define GOSSIP_HELLO_DEMO2 "Construct demolition."
#define GOSSIP_HELLO_DEMO3 "Construct siege engine."
#define GOSSIP_HELLO_DEMO4 "I can't build anything!"
