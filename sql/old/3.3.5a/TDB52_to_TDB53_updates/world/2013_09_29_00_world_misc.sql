DELETE FROM `server_string` WHERE `entry` IN (65, 66, 67, 68, 69, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 93, 94);
UPDATE `server_string` SET `entry` = 65 WHERE `entry` = 90;
UPDATE `server_string` SET `entry` = 66 WHERE `entry` = 91;
UPDATE `server_string` SET `entry` = 68 WHERE `entry` = 95;
UPDATE `server_string` SET `entry` = `entry` - 10 WHERE `entry` BETWEEN 82 AND 89;
